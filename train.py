...
if __name__ == "__main__":
    ...
    parser.add_argument("train_data", type=str, help="The path of training data")
    parser.add_argument("model_dir", type=str, help="The path to save the model")


    args = parser.parse_args()


    train(args.train_data, args.model_dir)
